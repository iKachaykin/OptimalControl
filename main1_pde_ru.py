...
if __name__ == '__main__':
    ...
    grid_interval_num_space, grid_interval_num_time = 10, 15
    ...
    terminal_state = np.log(s + 0.26) / np.log(10) + 1.0
    nu = 0.2
    calc_error_arg, calc_error_func, calc_error_grad = 1e-2, 1e-2, 1e-2
